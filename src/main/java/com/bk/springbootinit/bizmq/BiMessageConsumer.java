...
/**
 * 接受消息之后就是执行了，放在回调函数执行
 * @author bk
 * @data 2023/11/13 17:38
*/
@Component
@Slf4j
...
public class BiMessageConsumer
{
    ...
    public void receiveMessage(String message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) {
        ...
        updateChart.setStatus(GenChartStatusEnum.RUNNING.getStatus());
        ...
        // todo 建议定义状态为枚举值
        updateChartResult.setStatus(GenChartStatusEnum.SUCCEED.getStatus());
