...
import com.bk.springbootinit.constant.FileConstant;
import com.bk.springbootinit.exception.BusinessException;
import com.bk.springbootinit.manager.CosManager;
import com.bk.springbootinit.model.dto.file.UploadFileRequest;
import com.bk.springbootinit.model.entity.User;
import com.bk.springbootinit.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    private void validFile(MultipartFile multipartFile, FileUploadBizEnum fileUploadBizEnum) {
        ...
        if (FileUploadBizEnum.USER_AVATAR.equals(fileUploadBizEnum)) {
            ...
            if (!Arrays.asList("jpeg", "jpg", "svg", "png", "webp","PNG").contains(fileSuffix)) {
